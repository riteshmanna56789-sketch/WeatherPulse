...
export default function DailyForecast({ days }: DailyForecastProps) {
  ...
  return (
    <Panel eyebrow="Next 7 days" title="Daily trend" className="animate-rise">
          ...
          return (
            ...
            >
              <div>
                ...
                <p className="font-body text-xs text-slate">{day.date}</p>
              </div>

              <WeatherIcon condition={day.condition} className="h-5 w-5 text-dusk dark:text-amber" />
